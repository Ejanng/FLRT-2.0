...
function About() {
  const developers = [
    { name: 'Developer 1', role: 'Full Stack Developer', avatar: '👨‍💻' },
    { name: 'Developer 2', role: 'Frontend Developer', avatar: '👩‍💻' },
    { name: 'Developer 3', role: 'Backend Developer', avatar: '👨‍💻' },
    { name: 'Developer 4', role: 'UI/UX Designer', avatar: '👩‍🎨' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-800">
      ...
      {/* Features Section */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-700">
        <div className="max-w-4xl mx-auto">
