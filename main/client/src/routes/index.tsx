  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center px-4 py-12">
      <div className="text-center max-w-4xl mx-auto">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#0217f7]/10 border border-[#0217f7]/20 mb-8">
          <Sparkles size={16} className="text-[#f5e102]" />
          <span className="text-sm font-medium text-[#0217f7]">
        ...
        <div className="grid sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
          ...
          >
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Report Item</h3>
          ...
          <button
            ...
            className="group relative overflow-hidden rounded-2xl bg-white border-2 border-[#0217f7]/20 p-8 text-left transition-all hover:shadow-2xl hover:-translate-y-2"
          >
            ...
            <Search size={32} className="text-[#0217f7] mb-4" />
            <h3 className="text-xl font-bold text-gray-900 mb-2">Find Item</h3>
            <p className="text-gray-700 text-sm mb-4">Browse reported items and claim yours.</p>
            <div className="flex items-center text-[#0217f7] font-semibold">
        ...
        <div className="mt-16 grid grid-cols-3 gap-8">
          {statistics.map((stat) => (
            <div key={stat.key} className="text-center">
              <div className="text-3xl sm:text-4xl font-bold text-[#0217f7] mb-1">
                {stat.value}
              </div>
